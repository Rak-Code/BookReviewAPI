        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/books/create" className="text-gray-400 hover:text-white transition-colors">
                  Add Book
                </Link>
              </li>
              <li>
                <Link href="/my-reviews" className="text-gray-400 hover:text-white transition-colors">
                  My Reviews
                </Link>
              </li>
            </ul>
